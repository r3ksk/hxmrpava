In order to execute the tasks in this mission, you needed an Enterprise Account of SAP Business Technology Platform.
...
![SAP BTP Commercials!](../images/SAP_BTP_Commercial_Model.png)
